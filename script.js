...
checkoutBtn.addEventListener("click" , function(){
     ...
     const isOpen = checkRestaurantentOpen();
    if(!isOpen){
  


      Toastify({
        text: "Ops a Confeitaria está fechada!",
        duration: 3000,
        close: true,
...
function checkRestaurantentOpen(){
const data = new Date();
...
spanItem.classList.add("bg-green-600")
    ...
    spanItem.classList.remove("br-green-600")
